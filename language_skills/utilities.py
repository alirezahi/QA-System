...
fields = ['freq_1_count',
        ...
        'depRelation_type_count',
        'depRelation_type_count_to_all_depRelation',
        'constituency_node_token_count',
        'constituency_node_token_count_to_token_count',
...
class Analyser():
    def __init__(self, words, tf_idf=None, tf_idf_without_stopwords):
        ...
        self.depRelation_type_count = 0
        self.depRelation_type_count_to_all_depRelation = 0
        self.constituency_node_token_count = 0
        self.constituency_node_token_count_to_token_count = 0
        ...
        self.syllable_1_count_in_150_word_count_all_syllable = 0
        self.syllable_3_above_in_100_word = 0 # 61
        self.syllable_3_above_in_100_word_count_all_syllable = 0
        self.count_type_in_100_word = 0  # 62
        self.count_type_in_100_word_to_type_count = 0
        self.bigram_freq_1_above = 0    # 63
        self.bigram_freq_1 = 0  # 64
        self.bigram_freq_1_to_all_bigram_ratio = 0 # 65
        self.bigram_freq_1_above_to_all_bigram_ratio = 0
        self.trigram_freq_1_above = 0  # 66
        self.trigram_freq_1 = 0  # 67
        self.trigram_freq_1_to_all_trigram_ratio = 0  # 68
        self.trigram_freq_1_above_to_all_trigram_ratio = 0
        self.pos_bigram_freq_1_above = 0 # 69
        self.pos_bigram_freq_1 = 0  # 70
        self.pos_bigram_freq_1_to_all_bigram_ratio = 0  # 71
        self.pos_bigram_freq_1_above_to_all_bigram_ratio = 0
        self.pos_trigram_freq_1_above = 0  # 72
        self.pos_trigram_freq_1 = 0  # 73
        self.pos_trigram_freq_1_to_all_trigram_ratio = 0  # 74
        self.pos_trigram_freq_1_above_to_all_trigram_ratio = 0
        self.name_entity_count = 0 # 75
        self.name_entity_to_token_ratio = 0 # 76
        self.count_clauses_dependency = 0 # 77
        self.clause_dependency_to_total_dependency = 0 #78
    ...
    def analyse(self):
        ...
        self.constituency_node_token_count_analyse()
        self.constituency_node_token_count_to_token_count_analyse()
        self.depRelation_type_count_analyse()
        self.depRelation_type_count_to_all_depRelation_analyse()
        ...
        self.syllable_1_count_in_150_word_count_all_syllable_analyse()
        self.syllable_3_above_in_100_word_analyse()
        self.syllable_3_above_in_100_word_count_all_syllable_analyse()
        self.count_type_in_100_word_analyse()
        self.count_type_in_100_word_to_type_count_analyse()
        self.bigram_freq_1_analyse()
        self.bigram_freq_1_above_analyse()
        self.bigram_freq_1_to_all_bigram_ratio_analyse()
        self.bigram_freq_1_above_to_all_bigram_ratio_analyse()
        self.trigram_freq_1_analyse()
        self.trigram_freq_1_above_analyse()
        self.trigram_freq_1_to_all_trigram_ratio_analyse()
        self.trigram_freq_1_above_to_all_trigram_ratio_analyse()
        self.pos_bigram_freq_1_analyse()
        self.pos_bigram_freq_1_above_analyse()
        self.pos_bigram_freq_1_to_all_bigram_ratio_analyse()
        self.pos_bigram_freq_1_above_to_all_bigram_ratio_analyse()
        self.pos_trigram_freq_1_analyse()
        self.pos_trigram_freq_1_above_analyse()
        self.pos_trigram_freq_1_to_all_trigram_ratio_analyse()
        self.pos_trigram_freq_1_above_to_all_trigram_ratio_analyse()
    ...
    def depRelation_type_count_analyse(self):
        self.depRelation_type_count = len(self.freq_dict_dep)

    def depRelation_type_count_to_all_depRelation_analyse(self):
        self.depRelation_type_count_to_all_depRelation = self.depRelation_type_count / 49

    def constituency_node_token_count_to_token_count_analyse(self):
        self.constituency_node_token_count_to_token_count = self.constituency_node_token_count / self.token_count

        
    def constituency_node_token_count_analyse(self):
        result = 0
        for index, row in self.words.iterrows():
            if not math.isnan(float(row['q'])):
                result += row['ConstituencyNumberOfNodes'] if not math.isnan(row['ConstituencyNumberOfNodes']) else 0
        self.constituency_node_token_count = result
    ...
    def syllable_1_count_in_150_word_count_all_syllable_analyse(self):
        self.syllable_1_count_in_150_word_count_all_syllable = self.syllable_1_count_in_150_word / (self.count_all_syllable or 1)
    ...
    def syllable_3_above_in_100_word_count_all_syllable_analyse(self):
        self.syllable_3_above_in_100_word_count_all_syllable = self.syllable_3_above_in_100_word / (self.count_all_syllable or 1)
    ...
    def count_type_in_100_word_to_type_count_analyse(self):
        self.count_type_in_100_word_to_type_count = self.count_type_in_100_word / (self.type_count or 1)
    ...
    def bigram_freq_1_to_all_bigram_ratio_analyse(self):
        self.bigram_freq_1_to_all_bigram_ratio = self.bigram_freq_1 / (self.token_count - 1 or 1)

    def bigram_freq_1_above_to_all_bigram_ratio_analyse(self):
        self.bigram_freq_1_above_all_bigram_ratio = self.bigram_freq_1_above / (self.token_count - 1 or 1)
    ...
    def trigram_freq_1_to_all_trigram_ratio_analyse(self):
        self.trigram_freq_1_to_all_trigram_ratio = self.trigram_freq_1 / (self.token_count - 2 or 1)

    def trigram_freq_1_above_to_all_trigram_ratio_analyse(self):
        self.trigram_freq_1_above_to_all_trigram_ratio = self.trigram_freq_1_above / (self.token_count - 2 or 1)
    ...
    def pos_bigram_freq_1_to_all_bigram_ratio_analyse(self):
        self.pos_bigram_freq_1_to_all_bigram_ratio = self.pos_bigram_freq_1 / (self.token_count - 1 or 1)

    def pos_bigram_freq_1_above_to_all_bigram_ratio_analyse(self):
        self.pos_bigram_freq_1_above_to_all_bigram_ratio = self.pos_bigram_freq_1_above / (self.token_count - 1 or 1)
    ...
    def pos_trigram_freq_1_to_all_trigram_ratio_analyse(self):
        self.pos_trigram_freq_1_to_all_trigram_ratio = self.pos_trigram_freq_1 / (self.token_count - 2 or 1)

    def pos_trigram_freq_1_above_to_all_trigram_ratio_analyse(self):
        self.pos_trigram_freq_1_above_to_all_trigram_ratio = self.pos_trigram_freq_1_above / (self.token_count - 2 or 1)
    ...
    def clause_dependency_to_total_dependency_analyse(self):
        result = 0
        for index, row in self.words.iterrows():
            if not str(row['DepType']) == 'PUNC':
                result += 1

        self.clause_dependency_to_total_dependency = self.count_clauses_dependency/result
